...
namespace Graph {
    ...
    /*
     ...
     не меньше оттока. Активная вершина - это внутренняя вершина, приток в которой больше оттока (по согласованию, исток
     ...
     кратчайшего пути из этой вершины в сток остаточной сети.
